    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header card-header-primary">
                <h3 class="card-title">Reglements</h3>
            ...
            <div class="card-body">
                <div class="row pt-5 pl-5">
                    <h4>
                        reglement: {{$reglement->nom ?? 'Aucun reglement choisi'}}<br/>
                        Commune: {{$reglement->commune->nom ?? ''}}
                    </h4>
                </div>
                ...
                <form method="POST" action="{{route('clients.store')}}">
                    ...
                    <input type="hidden" name="reglement" value="{{$reglement->id}}" class="form-control" name="inputName" id="inputName" placeholder="">
